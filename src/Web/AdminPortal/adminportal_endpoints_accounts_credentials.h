...
class AdminPortalMethods_AccountsCredentials
{
public:
...
protected:
    ...
    static APIReturn unsetCredentialLockedStatus(void *context, const RequestParameters &request, ClientDetails &authClientDetails);
