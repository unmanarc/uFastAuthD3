...
public:
    ...
    public:
        ...
        // Application Roles
        bool updateAccountApplicationRoles(const std::string &appName, const std::string &accountName, const std::set<std::string> &roleSet) override;
        ...
        bool updateAccountDetailFieldValues(const std::string &accountName, const std::list<AccountDetailFieldValue> &inputFieldValues, bool isAdmin) override;
    ...
    public:
        ...
        Json::Value searchAccountPasswordActivity(const std::string &accountName, const json &dataTablesFilters) override;
    ...
    public:
        ...
        bool addApplication(const std::string &appName, const std::string &applicationDescription, const std::string &appURL, const std::string &apiKey, const std::string &creatorAccountName,
