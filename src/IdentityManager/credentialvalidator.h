...
public:
    ...
    [[nodiscard]] bool getUseTokenCache();
...
private:
     ...
     */
    [[nodiscard]] AuthenticationResult validateChallenge(const std::string &passwordFromDB, const std::string &challengeInput, const std::string &challengeSalt);
