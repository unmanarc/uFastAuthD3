...
protected:
     ...
     */
    AuthenticationResult validateStoredCredential(const std::string &accountName, const Credential &storedCredential, const std::string &passwordInput, const std::string &challengeSalt, Mode authMode);
...
private:
     ...
     * @return Authentication Response AuthenticationResult (authenticated or bad password)
     */
    AuthenticationResult validateChallenge(const std::string &passwordFromDB, const std::string &challengeInput, const std::string &challengeSalt);
    ...
    */
    AuthenticationResult validateGAuth(const std::string &accountName, const std::string &seed, const std::string &tokenInput);
