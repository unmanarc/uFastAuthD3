...
void WebSessionAuthHandler_AuthMethods::configureAccessToken(JWT::Token &accessToken, IdentityManager *identityManager, const std::string &refreshTokenId, const std::string &jwtAccountName,
...
void WebSessionAuthHandler_AuthMethods::configureRefreshToken(JWT::Token &refreshToken, IdentityManager *identityManager, const std::string &refreshTokenId, const std::string &jwtAccountName,
                                                              const std::string &appName, const ApplicationTokenProperties &tokenProperties, const std::set<uint32_t> &slotIds)
{
