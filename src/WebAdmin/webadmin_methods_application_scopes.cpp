...
void WebAdminMethods_ApplicationsScopes::getApplicationRolesForScope(void *context, APIReturn &response, const RequestParameters &request, ClientDetails &authClientDetails)
{
